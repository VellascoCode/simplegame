...
_c1 = TILE_SOURCES;
const DETAIL_SOURCES = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mapConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["detailPalette"].map(_c2 = (detail)=>({
        id: detail.id,
        key: `detail-${detail.id}`,
        path: detail.image
    }));
_c3 = DETAIL_SOURCES;
const BUILDING_SOURCES = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mapConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildingPalette"].map(_c4 = (building)=>({
        id: building.id,
        key: building.key,
        path: building.image,
        blockingHeight: building.blockingHeight
    }));
_c5 = BUILDING_SOURCES;
const dPad = [
    {
        label: "↑",
        dx: 0,
                                ...
                                "CityPhaser.useEffect": (row, rowIndex)=>{
                                    row.forEach({
                                        "CityPhaser.useEffect": (cell, columnIndex)=>{
                                            if (cell <= 0) return;
                                            const def = DETAIL_SOURCES.find({
                                                "CityPhaser.useEffect.def": (detail)=>detail.id === cell
...
__turbopack_context__.k.register(_c2, "DETAIL_SOURCES$detailPalette.map");
__turbopack_context__.k.register(_c3, "DETAIL_SOURCES");
__turbopack_context__.k.register(_c4, "BUILDING_SOURCES$buildingPalette.map");
__turbopack_context__.k.register(_c5, "BUILDING_SOURCES");
__turbopack_context__.k.register(_c6, "CityPhaser");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_6c80122d._.js.map