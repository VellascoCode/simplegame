...
"[project]/lib/factions.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$factions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/factions.ts [app-client] (ecmascript)");
;
        ...
        "CityPhaser.useEffect": ()=>{
            ...
            ({
                "CityPhaser.useEffect": async ()=>{
                    ...
                    const detailLookup = new Map(detailTiles.map({
                        "CityPhaser.useEffect": (tile)=>[
                                tile.id,
                                tile
                            ]
                    ...
                    class CityScene extends Phaser.Scene {
                        ...
                        create() {
                            ...
                            this.time.addEvent({
                                ...
                                loop: true,
                                callback: {
                                    "CityPhaser.useEffect": ()=>this.advanceNPCs(0.11)
                                }["CityPhaser.useEffect"]
                            });
                        ...
                        spawnNPCs() {
                            ...
                            for(let i = 0; i < 4; i++){
                                const faction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$factions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRandomFaction"])();
                        ...
                        scheduleWorldCleanup() {
                            ...
                            this.cleanupTimer = this.time.addEvent({
                                ...
                                loop: true,
                                callback: {
                                    "CityPhaser.useEffect": ()=>this.cleanWorldState()
                                }["CityPhaser.useEffect"]
                            });
                        }
                        cleanWorldState() {
                        ...
                        findEnemyLancerTarget(lancer, lancers, warInfo, playerTile) {
                            ...
                            const enemies = lancers.filter({
                                "CityPhaser.useEffect.enemies": (candidate)=>candidate !== lancer && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$factions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isOpposingFaction"])(candidate.faction, lancer.faction, warInfo)
                            }["CityPhaser.useEffect.enemies"]);
                            if (!enemies.length) return null;
                            let best = null;
                            let bestDistance = Number.POSITIVE_INFINITY;
                            enemies.forEach({
                                "CityPhaser.useEffect": (enemy)=>{
                        ...
                        playerAttack() {
                            ...
                            const playerTile = worldToTile(this.player.x, this.player.y);
                            const targets = this.lancers.filter({
                                "CityPhaser.useEffect.targets": (lancer)=>{
                            ...
                            }["CityPhaser.useEffect.targets"]);
                            targets.forEach({
                                "CityPhaser.useEffect": (lancer)=>this.applyHeroStrike(lancer)
                            }["CityPhaser.useEffect"]);
                        }
                        ...
                        handleLancerDeath(lancer) {
                            ...
                            void (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clientApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["postJSON"])("/api/factions/war", {
                        ...
                        async recordBestiaryKill(monsterId) {
                            if (!this.playerOwnerId || !this.playerCharacterId) return;
                            try {
                                const table = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clientApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["postJSON"])("/api/bestiary/update", {
                                    ownerId: this.playerOwnerId,
                                    characterId: this.playerCharacterId,
                                    monsterId
                                });
                        ...
                        maybeChant(faction, x, y) {
                            const chants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$factions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFactionChants"])(faction);
...
_s(CityPhaser, "z0HVPojD+PC3htpOFo/26szqiVs=");
_c = CityPhaser;
var _c;
...
_s(CityPage, "6W82KqgolGmGyVogF997z/zPrVI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=_b4b7a938._.js.map