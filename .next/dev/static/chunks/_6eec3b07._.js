...
function handlePlayerMovement({ player, cursors, virtualDirection, collisionZones, npcs, worldWidth, worldHeight, heroAttacking, delta, syncPosition }) {
    ...
    dx /= length;
    dy /= length;
    const proposedX = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Math.Clamp(player.x + dx * __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_SPEED"] * (delta / 1000), player.displayWidth / 2, worldWidth - player.displayWidth / 2);
    const proposedY = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Math.Clamp(player.y + dy * __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_SPEED"] * (delta / 1000), player.displayHeight / 2, worldHeight);
    const collidesWithNPC = npcs.some((npc)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Math.Distance.Between(npc.sprite.x, npc.sprite.y, proposedX, proposedY) < 40);
    const playerFeet = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Geom.Circle(proposedX, proposedY - 8, 18);
    const collidesWithCollision = collisionZones.some((zone)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Geom.Intersects.CircleToRectangle(playerFeet, zone));
...
function randomPoint(scene, width, height) {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Math.Vector2(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Math.Between(80, width - 80), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Math.Between(80, height - 80));
}
...
function spawnNPCs(scene, count, worldWidth, worldHeight, npcColors, names, records) {
    for(let i = 0; i < count; i++){
        const sprite = scene.add.sprite(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Math.Between(120, worldWidth - 120), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Math.Between(120, worldHeight - 120), "hero-idle-sheet", 0);
        sprite.setOrigin(0.5, 1);
        sprite.setScale(1);
        sprite.setTint(npcColors[i % npcColors.length]);
        sprite.play("hero-idle");
        sprite.setDepth(sprite.y);
        const level = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Math.Between(3, 12);
...
function updateNPCs(scene, npcs, delta, worldWidth, worldHeight) {
    const speed = 60;
    npcs.forEach((npc)=>{
        const dir = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Math.Vector2(npc.target.x - npc.sprite.x, npc.target.y - npc.sprite.y);
        if (dir.length() < 10) {
...
function updateLancers(player, lancers, delta, allowCombat) {
    ...
    const ordered = activeLancers.map((entry)=>({
            lancer: entry,
            distance: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Math.Distance.Between(entry.sprite.x, entry.sprite.y, player.x, player.y)
    ...
    activeLancers.forEach((lancer)=>{
        const dir = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Math.Vector2(player.x - lancer.sprite.x, player.y - lancer.sprite.y);
        const distance = dir.length();
        const direction = distance > 0 ? dir.clone().normalize() : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Math.Vector2();
        ...
        const separation = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Math.Vector2();
        activeLancers.forEach((other)=>{
            if (other === lancer) return;
            const offset = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Math.Vector2(lancer.sprite.x - other.sprite.x, lancer.sprite.y - other.sprite.y);
...
function setupHeroAnimations(scene, player) {
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HERO_CONFIG"].attack) return;
...
function triggerHeroAttack(scene, player, flag) {
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HERO_CONFIG"].attack || flag.attacking) return;
    flag.attacking = true;
    player.play("hero-attack", true);
    const duration = __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HERO_CONFIG"].attack.frames / __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HERO_CONFIG"].attack.frameRate * 1000;
                    ...
                    class CityScene extends Phaser.Scene {
                        ...
                        spawnNPCs() {
                            ...
                            for(let i = 0; i < 4; i++){
                                ...
                                sprite.setOrigin(0.5, 1);
                                sprite.setScale(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HERO_SCALE"]);
                        ...
                        updateLancers(delta) {
                            ...
                            const allowed = new Set(ordered.slice(0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAX_ATTACKERS"]).map({
                            ...
                            activeLancers.forEach({
                                "CityPhaser.useEffect": (lancer)=>{
                                    ...
                                    lancer.sprite.setDepth(lancer.sprite.y);
                                    lancer.label.setPosition(lancer.sprite.x, lancer.sprite.y - lancer.sprite.displayHeight - 4).setDepth(lancer.sprite.depth + 5);
                                    if (isAllowed && distance < __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_DISTANCE"]) {
                        ...
                        update(_, delta) {
                            ...
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$movement$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handlePlayerMovement"])({
                                ...
                                delta,
                                syncPosition: {
                                    "CityPhaser.useEffect": (x, y, force)=>this.syncPlayerPosition(x, y, force)
                                }["CityPhaser.useEffect"]
                            });
                            ...
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$npcAI$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateLancers"])(this.player, this.lancers, delta, {
                                "CityPhaser.useEffect": (lancer)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$combat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handleCombat"])(lancer, {
                                        ...
                                        emitCombatLog: {
                                            "CityPhaser.useEffect": (event)=>combatEventRef?.(event)
                                        }["CityPhaser.useEffect"],
...
//# sourceMappingURL=_6eec3b07._.js.map