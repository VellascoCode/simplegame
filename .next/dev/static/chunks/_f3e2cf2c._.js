...
class CityScene extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Scene"] {
    cursors;
    player;
    floorLayer;
    map;
    ...
    create() {
        ...
        this.events.once(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Scenes"].Events.SHUTDOWN, ()=>{
    ...
    buildMapMatrix() {
        return Array.from({
            length: MAP_HEIGHT_TILES
                ...
                length: MAP_WIDTH_TILES
            }, (_, columnIndex)=>{
                const isBorder = rowIndex === 0 || columnIndex === 0 || rowIndex === MAP_HEIGHT_TILES - 1 || columnIndex === MAP_WIDTH_TILES - 1;
    ...
    createFloorTexture() {
        ...
        const canvas = this.textures.createCanvas("city-floor", MAP_TILE_SIZE * FLOOR_SOURCES.length, MAP_TILE_SIZE);
        if (!canvas) return;
    ...
    update(_, delta) {
        ...
        this.player.x = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Math"].Clamp(this.player.x + dx * PLAYER_SPEED * deltaSeconds, bounds.minX, bounds.maxX);
        this.player.y = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Math"].Clamp(this.player.y + dy * PLAYER_SPEED * deltaSeconds, bounds.minY, bounds.maxY);
...
function CityPhaser() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CityPhaser.useEffect": ()=>{
            ...
            const game = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Game"]({
...
_s(CityPhaser, "8uVE59eA/r6b92xF80p7sH8rXLk=");
_c = CityPhaser;
var _c;
...
function InventoryPanel({ ownerId }) {
    ...
    const [removeItemId, setRemoveItemId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [removeQty, setRemoveQty] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    async function handleAdd(event) {
        ...
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clientApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["postJSON"])("/api/inventory/add", payload);
            setItems(response);
...
_s(InventoryPanel, "iLqFhLQu7FdwkTTI6XwolM3qXUI=");
_c = InventoryPanel;
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        children: [
                            ...
                            " (100×100 cada), reamostrados para blocos de 32 px no Phaser. O mapa foi ampliado e continua responsivo — abra em tela cheia para explorar melhor."
                        ]
                    }, void 0, true, {
                        fileName: "[project]/app/city/page.tsx",
                        lineNumber: 76,
...
//# sourceMappingURL=_f3e2cf2c._.js.map