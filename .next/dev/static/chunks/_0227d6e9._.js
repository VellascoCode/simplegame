                ...
                "CityPhaser.useEffect": async ()=>{
                    ...
                    class CityScene extends Phaser.Scene {
                        ...
                        handlePlayerMovement(delta) {
                            ...
                            dx /= length;
                            dy /= length;
                            const proposedX = Phaser.Math.Clamp(this.player.x + dx * __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_SPEED"] * (delta / 1000), this.player.displayWidth / 2, this.worldWidth - this.player.displayWidth / 2);
                            const proposedY = Phaser.Math.Clamp(this.player.y + dy * __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_SPEED"] * (delta / 1000), this.player.displayHeight / 2, this.worldHeight);
                        ...
                        refreshPlayerDepth() {
                            if (!this.player) return;
                            const tileX = Math.max(0, Math.floor(this.player.x / __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_TILE_SIZE"]));
                            const tileY = Math.max(0, Math.floor(this.player.y / __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_TILE_SIZE"]));
...
//# sourceMappingURL=_0227d6e9._.js.map