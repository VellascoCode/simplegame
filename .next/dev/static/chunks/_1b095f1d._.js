                    ...
                    class CityScene extends Phaser.Scene {
                        ...
                        spawnNPCs() {
                            ...
                            this.npcs.slice(initialCount).forEach({
                                "CityPhaser.useEffect": (npc)=>this.scheduleSpeech(npc)
                            }["CityPhaser.useEffect"]);
                        }
                        scheduleSpeech(npc) {
                            const messages = [
                        ...
                        spawnLancer(index = 0) {
                            const position = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["randomPoint"])(this, this.worldWidth, this.worldHeight);
                        ...
                        handleLancerDeath(lancer) {
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showFloatingText"])(this, this.player.x, this.player.y - this.player.displayHeight - 30, "+2 XP", "#94f1a4");
                            this.emitCombatLog({
                                message: "+2 XP",
                                tone: "xp"
                            });
                            playToneRef(620);
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$drops$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["grantRewards"])(this, this.player, {
                                awardGold: {
...
_s(CityPhaser, "YZn3GFFbRZc1HLmAeHT7qou+3+s=", false, function() {
    return [
...
function CityPage() {
    ...
    const formatFactionNames = (ids)=>ids.map((id)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$factions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FACTION_NAMES"][id] ?? `Facção ${id}`).join(" & ");
...
//# sourceMappingURL=_1b095f1d._.js.map