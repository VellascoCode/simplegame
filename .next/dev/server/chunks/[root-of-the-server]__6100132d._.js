...
"[project]/app/api/session/select/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    if (!ownerId) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["error"])("Sessão expirada", 401);
    }
    const body = await request.json();
    const characterId = typeof body.characterId === "string" ? body.characterId : "";
    const map = typeof body.map === "string" ? body.map : "city";
    if (!characterId) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["error"])("characterId obrigatório", 400);
    }
    ...
    if (!character) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["error"])("Personagem não encontrado", 404);
    }
    const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repositories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPlayerSession"])(ownerId) ?? null;
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repositories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["savePlayerSession"])({
        ownerId,
        characterId,
        map,
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ok"])(session);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__6100132d._.js.map