            ...
            class CityScene extends Phaser.Scene {
                ...
                spawnNPCs() {
                    ...
                    for(let i = 0; i < NPC_COUNT; i++){
                        const sprite = this.add.sprite(Phaser.Math.Between(100, this.worldWidth - 100), Phaser.Math.Between(100, this.worldHeight - 100), PLAYER_SPRITE_KEY, Phaser.Math.Between(0, 5));
                        sprite.setOrigin(0.5, 1);
                        sprite.setScale(PLAYER_SCALE * 0.8);
                        sprite.setDepth(18);
                ...
                scheduleSpeech(npc) {
                    const messages = [
                        "Olá viajante!",
                        "Em breve teremos eventos.",
                        "Precisa de ajuda?",
                        "Clima perfeito para explorar."
                    ];
                    this.time.addEvent({
                        delay: Phaser.Math.Between(4000, 9000),
                        callback: ()=>{
                            const message = messages[Phaser.Math.Between(0, messages.length - 1)];
                            const text = this.add.text(npc.sprite.x, npc.sprite.y - npc.sprite.displayHeight, message, {
                                color: "#fff3d4",
                                fontSize: "14px",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1a9ad865._.js.map