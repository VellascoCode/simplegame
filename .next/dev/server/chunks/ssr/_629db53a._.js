...
const PLAYER_SCALE = 0.33;
const PLAYER_SPEED = 180;
class CityScene extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Scene"] {
    cursors;
    player;
    floorLayer;
    map;
    ...
    preload() {
        this.load.image("city-tilesheet", "/tilesets/tile1.png");
    ...
    create() {
        ...
        this.events.once(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Scenes"].Events.SHUTDOWN, ()=>{
    ...
    buildMapMatrix() {
        return Array.from({
            length: MAP_HEIGHT_TILES
        }, ()=>Array(MAP_WIDTH_TILES).fill(0));
    }
    buildFloor() {
    ...
    createFloorTexture() {
        ...
        const sourceImage = this.textures.get("city-tilesheet").getSourceImage();
        const canvas = this.textures.createCanvas("city-floor", MAP_TILE_SIZE, MAP_TILE_SIZE);
        if (!canvas) return;
        const ctx = canvas.getContext();
        if (!ctx) return;
        ctx.drawImage(sourceImage, 0, 0, sourceImage.width, sourceImage.height, 0, 0, MAP_TILE_SIZE, MAP_TILE_SIZE);
        canvas.refresh();
    }
    createPlayer() {
    ...
    centerMap(width = this.scale.width, height = this.scale.height) {
    ...
    update(_, delta) {
        ...
        this.player.x = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Math"].Clamp(this.player.x + dx * PLAYER_SPEED * deltaSeconds, bounds.minX, bounds.maxX);
        this.player.y = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Math"].Clamp(this.player.y + dy * PLAYER_SPEED * deltaSeconds, bounds.minY, bounds.maxY);
...
function CityPhaser() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const game = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Game"]({
...
function InventoryPanel({ ownerId }) {
    ...
    const [removeItemId, setRemoveItemId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    const [removeQty, setRemoveQty] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(1);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!ownerId) {
            setItems([]);
            return;
    ...
    async function handleAdd(event) {
        ...
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clientApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["postJSON"])("/api/inventory/add", payload);
            setItems(response);
...
function CityPage() {
    ...
    async function handleManualLoad() {
        if (!ownerId || !characterId) {
            setFeedback("Informe ownerId e characterId para carregar o personagem.");
            return;
        }
        await loadSelectedCharacter(ownerId, characterId);
    }
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        children: "Esta é a primeira área após o login. Use os parâmetros recebidos da tela inicial para carregar o personagem selecionado e sincronizar inventário + lista de online."
                    }, void 0, false, {
                        fileName: "[project]/app/city/page.tsx",
                        lineNumber: 66,
                        columnNumber: 9
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        children: [
                            ...
                            " (tile único 100×87 convertido para 64 px quadrado). O mapa fica centralizado e responsivo — redimensione para ver o Phaser se ajustar."
                        ]
                    }, void 0, true, {
                        fileName: "[project]/app/city/page.tsx",
                        lineNumber: 107,
...
//# sourceMappingURL=_629db53a._.js.map