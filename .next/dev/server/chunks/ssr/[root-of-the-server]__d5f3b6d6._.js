...
const TILE_SOURCES = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mapConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["groundTilePalette"].map((tile, index)=>({
        id: tile.id,
        key: `city-tile-source-${index}`,
        path: tile.image
    }));
const DETAIL_SOURCES = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mapConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["detailPalette"].map((detail)=>({
        id: detail.id,
        key: `detail-${detail.id}`,
        path: detail.image
    }));
const BUILDING_SOURCES = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mapConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildingPalette"].map((building)=>({
        id: building.id,
        key: building.key,
        path: building.image,
            ...
            class CityScene extends Phaser.Scene {
                ...
                renderDetails() {
                    mapReference.detail.forEach((row, rowIndex)=>{
                        row.forEach((cell, columnIndex)=>{
                            if (cell <= 0) return;
                            const def = DETAIL_SOURCES.find((detail)=>detail.id === cell);
                            if (!def) return;
                            const sprite = this.add.image(columnIndex * MAP_TILE_SIZE + MAP_TILE_SIZE / 2, rowIndex * MAP_TILE_SIZE + MAP_TILE_SIZE / 2, def.key);
                ...
                renderBuildings() {
                    mapReference.buildings.forEach((row, rowIndex)=>{
                        row.forEach((cell, columnIndex)=>{
                            if (cell <= 0) return;
                            const def = BUILDING_SOURCES.find((building)=>building.id === cell);
                            if (!def) return;
                ...
                update(_, delta) {
                    ...
                    const collidesWithBuilding = this.buildingZones.some((zone)=>zone.contains(proposedX, proposedY));
...
"[project]/components/InventorySummary.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ChatPanel({ ownerId: forcedOwnerId, characterName }) {
    ...
    const [name, setName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(characterName ?? "");
...
"[project]/components/ChatModal.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$InventorySummary$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/InventorySummary.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ChatModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ChatModal.tsx [app-ssr] (ecmascript)");
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        children: [
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            ownerId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$InventorySummary$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["InventorySummary"], {
                                ownerId: ownerId
                            }, void 0, false, {
                                fileName: "[project]/app/city/page.tsx",
                                lineNumber: 85,
            ...
            ownerId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ChatModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChatModal"], {
                    ownerId: ownerId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d5f3b6d6._.js.map