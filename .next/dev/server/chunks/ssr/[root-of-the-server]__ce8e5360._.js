...
class CityScene extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Scene"] {
    ...
    create() {
        ...
        this.player = this.add.rectangle(0, 0, 20, 20, 0x00b5d8);
    ...
    createFloorTexture() {
        ...
        const framesPerAxis = 4;
        const sourceTileSize = sourceImage.width / framesPerAxis;
        const canvas = this.textures.createCanvas("city-floor", MAP_TILE_SIZE, MAP_TILE_SIZE);
        if (!canvas) return;
        const ctx = canvas.getContext();
        if (!ctx) return;
        ctx.drawImage(sourceImage, 0, 0, sourceTileSize, sourceTileSize, 0, 0, MAP_TILE_SIZE, MAP_TILE_SIZE);
        canvas.refresh();
    }
    ...
    update(_, delta) {
        ...
        dy /= length;
        const bounds = {
            minX: this.mapOffset.x + this.player.width / 2,
            maxX: this.mapOffset.x + this.map.widthInPixels - this.player.width / 2,
            minY: this.mapOffset.y + this.player.height / 2,
            maxY: this.mapOffset.y + this.map.heightInPixels - this.player.height / 2
        };
        this.player.x = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Math"].Clamp(this.player.x + dx * speed * deltaSeconds, bounds.minX, bounds.maxX);
        this.player.y = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phaser$2f$dist$2f$phaser$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Math"].Clamp(this.player.y + dy * speed * deltaSeconds, bounds.minY, bounds.maxY);
    }
}
function CityPhaser() {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        children: [
                            ...
                            " recortado automaticamente (grid 4×4). O canvas é responsivo e centralizado — redimensione a tela para ver o mapa reencaixar."
                        ]
                    }, void 0, true, {
                        fileName: "[project]/app/city/page.tsx",
                        lineNumber: 107,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ce8e5360._.js.map