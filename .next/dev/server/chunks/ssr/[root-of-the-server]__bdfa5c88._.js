...
"[project]/components/game/constants.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/game/phaserInstance.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/game/layers.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/constants.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$phaserInstance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/phaserInstance.ts [app-ssr] (ecmascript)");
;
;
function createFloorTexture(scene, key, groundTiles) {
    if (scene.textures.exists(key)) return;
    const canvas = scene.textures.createCanvas(key, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MAP_TILE_SIZE"] * groundTiles.length, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MAP_TILE_SIZE"]);
    if (!canvas) return;
...
function buildCollisionZones(collision) {
    const Phaser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$phaserInstance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPhaserInstance"])();
    const zones = [];
...
"[project]/components/game/movement.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function handlePlayerMovement({ player, cursors, virtualDirection, collisionZones, npcs, worldWidth, worldHeight, heroAttacking, delta, syncPosition }) {
    ...
    dx /= length;
    dy /= length;
    const proposedX = Phaser.Math.Clamp(player.x + dx * __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PLAYER_SPEED"] * (delta / 1000), player.displayWidth / 2, worldWidth - player.displayWidth / 2);
    const proposedY = Phaser.Math.Clamp(player.y + dy * __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PLAYER_SPEED"] * (delta / 1000), player.displayHeight / 2, worldHeight);
...
"[project]/components/game/utils.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function worldToTile(x, y) {
    return {
        x: Math.max(0, Math.floor(x / __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MAP_TILE_SIZE"])),
        y: Math.max(0, Math.floor(y / __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MAP_TILE_SIZE"]))
    };
}
function clampPlayerDepth(player, coverMatrix, label) {
    const tileX = Math.max(0, Math.floor(player.x / __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MAP_TILE_SIZE"]));
    const tileY = Math.max(0, Math.floor(player.y / __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MAP_TILE_SIZE"]));
    const coverValue = coverMatrix[tileY]?.[tileX] ?? 0;
    const depthOffset = coverValue > 0 ? -__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["COVER_DEPTH_OFFSET"] : __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["COVER_DEPTH_OFFSET"];
...
"[project]/components/game/npcAI.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/constants.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/utils.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$phaserInstance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/phaserInstance.ts [app-ssr] (ecmascript)");
;
;
;
function spawnNPCs(scene, count, worldWidth, worldHeight, npcColors, names, records) {
    ...
    for(let i = 0; i < count; i++){
        ...
        records.push({
            sprite,
            label,
            target: (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["randomPoint"])(scene, worldWidth, worldHeight),
            name
        });
    }
}
function updateNPCs(scene, npcs, delta, worldWidth, worldHeight) {
    ...
    npcs.forEach((npc)=>{
        ...
        if (dir.length() < 10) {
            npc.target = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["randomPoint"])(scene, worldWidth, worldHeight);
...
function updateLancers(player, lancers, delta, allowCombat) {
    ...
    const allowed = new Set(ordered.slice(0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MAX_ATTACKERS"]).map((entry)=>entry.lancer));
    activeLancers.forEach((lancer)=>{
        ...
        if (isAllowed && distance > __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["STOP_DISTANCE"]) {
            lancer.sprite.x += direction.x * __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_SPEED"] * (delta / 1000);
            lancer.sprite.y += direction.y * __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_SPEED"] * (delta / 1000);
            lancer.sprite.setFlipX(direction.x < 0);
            lancer.sprite.play("lancer-run", true);
        } else if (!isAllowed && distance < __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["STOP_DISTANCE"] + 30 && distance > 0) {
            lancer.sprite.x -= direction.x * (__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_SPEED"] * 0.6) * (delta / 1000);
            lancer.sprite.y -= direction.y * (__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_SPEED"] * 0.6) * (delta / 1000);
            lancer.sprite.setFlipX(direction.x < 0);
            lancer.sprite.play("lancer-run", true);
        }
        ...
        activeLancers.forEach((other)=>{
            ...
            if (dist > 0 && dist < __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_SEPARATION_RADIUS"]) {
                offset.normalize().scale((__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_SEPARATION_RADIUS"] - dist) / __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_SEPARATION_RADIUS"]);
                separation.add(offset);
            }
        });
        if (separation.lengthSq() > 0) {
            separation.normalize();
            lancer.sprite.x += separation.x * __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_SEPARATION_FORCE"] * (delta / 1000);
            lancer.sprite.y += separation.y * __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_SEPARATION_FORCE"] * (delta / 1000);
        }
...
"[project]/components/game/combat.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function handleCombat(lancer, deps) {
    ...
    if (now - lancer.lastAttack < __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_COOLDOWN"]) return;
    lancer.lastAttack = now;
    deps.triggerHeroAttack();
    deps.triggerLancerAttack(lancer);
    const heroDamage = Phaser.Math.Between(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HERO_DAMAGE_MIN"], __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HERO_DAMAGE_MAX"]);
    const lancerDamage = Phaser.Math.Between(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_DAMAGE_MIN"], __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_DAMAGE_MAX"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showFloatingText"])(deps.scene, lancer.sprite.x, lancer.sprite.y - lancer.sprite.displayHeight, `-${heroDamage} HP`, "#fff6c4");
    deps.emitCombatLog?.({
        message: `${lancer.label.text} perdeu ${heroDamage} HP`,
        tone: "damage"
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showFloatingText"])(deps.scene, deps.player.x, deps.player.y - deps.player.displayHeight - 6, `-${lancerDamage} HP`, "#ff7a7a");
    deps.emitCombatLog?.({
...
"[project]/components/game/playerActions.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function triggerLancerAttack(scene, lancer) {
    ...
    const duration = __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_COOLDOWN"] / 2;
    scene.time.delayedCall(duration, ()=>{
...
function applyDamageToPlayer(scene, player, amount, source, emitCombatLog, playTone) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showFloatingText"])(scene, player.x, player.y - player.displayHeight - 6, `-${amount} HP`, "#ff8e8e");
    emitCombatLog?.({
...
"[project]/components/game/dialog.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/game/drops.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function grantRewards(scene, player, callbacks, monsterType) {
    const Phaser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$phaserInstance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPhaserInstance"])();
    const goldReward = Phaser.Math.Between(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GOLD_REWARD_MIN"], __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GOLD_REWARD_MAX"]);
    if (goldReward > 0) {
...
"[project]/components/game/lancers.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/constants.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/utils.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$drops$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/drops.ts [app-ssr] (ecmascript)");
;
;
;
function createLancer(scene, index, tints, worldWidth, worldHeight, runSheet, runAnim) {
    const spawnPoint = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["randomPoint"])(scene, worldWidth, worldHeight);
    const sprite = scene.add.sprite(spawnPoint.x, spawnPoint.y, runSheet, 0);
    sprite.setOrigin(0.5, 1);
    sprite.setScale(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_SCALE"]);
    ...
    return {
        sprite,
        label,
        hp: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_HP"],
        lastAttack: 0,
        type: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MonsterType"].Lancer
    };
}
function handleLancerDeath(scene, player, lancer, callbacks) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showFloatingText"])(scene, player.x, player.y - player.displayHeight - 30, "+2 XP", "#94f1a4");
    callbacks.emitXp();
    callbacks.playTone(620);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$drops$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["grantRewards"])(scene, player, {
...
"[project]/hooks/useSessionPosition.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useSessionPosition(onPositionChange) {
    ...
    const lastSync = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
    const syncPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((x, y, force = false)=>{
        const deltaX = Math.abs(x - lastX.current);
        const deltaY = Math.abs(y - lastY.current);
        const movedTiles = Math.max(deltaX, deltaY) / __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MAP_TILE_SIZE"];
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/constants.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$layers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/layers.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$movement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/movement.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$npcAI$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/npcAI.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$combat$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/combat.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/utils.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$playerActions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/playerActions.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$phaserInstance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/phaserInstance.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$dialog$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/dialog.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$lancers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/game/lancers.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useSessionPosition$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useSessionPosition.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
const BESTIARY_MONSTER_ID = __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MonsterType"].Lancer;
const NPC_COLORS = [
    0x5dade2,
    0xffa07a,
    0xfff176,
...
function CityPhaser({ ownerId, characterId, characterName, characterLevel, characterXp, warState, initialPosition, onPositionChange, onCombatEvent, onStatsChange, onGoldChange, onBestiaryUpdate, soundEnabled = true, onReady }) {
    ...
    const goldHandlerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(undefined);
    const bestiaryHandlerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(undefined);
    ...
    const statsHandlerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(undefined);
    ...
    const syncSessionPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useSessionPosition$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSessionPosition"])(onPositionChange);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        (async ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$phaserInstance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setPhaserInstance"])(Phaser);
            ...
            class CityScene extends Phaser.Scene {
                ...
                initializeScene() {
                    ...
                    this.createPlayer();
                    this.spawnNPCs();
                    this.spawnLancers(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_COUNT"]);
                }
                configureCamera() {
                    if (!this.map) return;
                ...
                buildFloor() {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$layers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createFloorTexture"])(this, "city-floor", groundTiles);
                    this.map = this.make.tilemap({
                        data: mapReference.ground,
                        tileWidth: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MAP_TILE_SIZE"],
                        tileHeight: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MAP_TILE_SIZE"]
                    });
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$layers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["renderDetails"])(this, mapReference.detail, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MAP_TILE_SIZE"]);
                    this.worldWidth = this.map.widthInPixels;
                    this.worldHeight = this.map.heightInPixels;
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$layers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["renderBuildings"])(this, mapReference.buildings, buildingLookup);
                    this.collisionZones = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$layers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildCollisionZones"])(mapReference.collision);
                    this.dropLayer = this.add.layer();
                }
                createPlayer() {
                    this.player = this.add.sprite(0, 0, HERO_RUN_SHEET_KEY, 0);
                    this.player.setOrigin(0.5, 1);
                    this.player.setScale(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HERO_SCALE"]);
                    this.player.setDepth(this.player.y + __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["COVER_DEPTH_OFFSET"]);
                ...
                spawnNPCs() {
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$npcAI$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["spawnNPCs"])(this, names.length, this.worldWidth, this.worldHeight, NPC_COLORS, names, this.npcs);
                    this.npcs.slice(initialCount).forEach((npc)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$dialog$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scheduleNpcSpeech"])(this, npc));
                }
                spawnLancers(count) {
                    for(let i = 0; i < count; i++){
                        this.spawnLancer(i);
                ...
                spawnGroundDrop(def, position) {
                    ...
                    this.time.delayedCall(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GROUND_DROP_TTL"], ()=>{
                        sprite.destroy();
                        label.destroy();
                ...
                handleDropRewards(position) {
                    ...
                    if (highRoll <= __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MEDIUM_CRYSTAL_DROP_CHANCE"]) {
                        void this.rewardCrystal(CRYSTAL_DROPS.medium, position);
                        return;
                    }
                    if (highRoll <= __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MEDIUM_CRYSTAL_DROP_CHANCE"] + __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SMALL_CRYSTAL_DROP_CHANCE"]) {
                        void this.rewardCrystal(CRYSTAL_DROPS.small, position);
                    }
                }
                triggerHeroAttack() {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$playerActions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["triggerHeroAttack"])(this, this.player, {
                ...
                triggerLancerAttack(lancer) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$playerActions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["triggerLancerAttack"])(this, lancer);
                }
                handleLancerDeath(lancer) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$lancers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleLancerDeath"])(this, this.player, lancer, {
                        emitXp: ()=>{
                            this.emitCombatLog({
                                message: `+${__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_XP_REWARD"]} XP`,
                                tone: "xp"
                            });
                            this.grantXp(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LANCER_XP_REWARD"]);
                        },
                ...
                awardGold(amount) {
                    if (!this.playerOwnerId || !this.playerCharacterId || amount <= 0) return;
                    void (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clientApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["postJSON"])("/api/character/gold", {
                        ownerId: this.playerOwnerId,
                        characterId: this.playerCharacterId,
                        amount
                    }).then(({ gold })=>{
                ...
                recordBestiaryKill(monsterId) {
                    ...
                    void (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clientApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["postJSON"])("/api/bestiary/update", {
                        ownerId: this.playerOwnerId,
                        characterId: this.playerCharacterId,
                        monsterId
                    }).then((entries)=>{
                ...
                update(_, delta) {
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$movement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handlePlayerMovement"])({
                        player: this.player,
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clampPlayerDepth"])(this.player, mapReference.cover, this.playerLabel);
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$npcAI$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateNPCs"])(this, this.npcs, delta, this.worldWidth, this.worldHeight);
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$npcAI$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateLancers"])(this.player, this.lancers, delta, (lancer)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$combat$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleCombat"])(lancer, {
                            scene: this,
                            player: this.player,
                            ...
                            triggerLancerAttack: (target)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$playerActions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["triggerLancerAttack"])(this, target),
            ...
            const getSize = ()=>{
                ...
                const widthCandidate = Math.round(baseWidth * __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PINCH_SCALE"]) + 4 * __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MAP_TILE_SIZE"];
                const width = Math.max(620, Math.min(maxWidth, widthCandidate));
                const baseHeight = Math.round(width * (isDesktop ? 0.5 : 0.66));
                const height = baseHeight + 3 * __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MAP_TILE_SIZE"];
                return {
                    width,
                    height
                };
...
function useXp(ownerId, characterId) {
    const grantXp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (amount)=>{
        if (!ownerId || !characterId || amount <= 0) return;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clientApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["postJSON"])("/api/character/xp", {
            ownerId,
            characterId,
            amount
        }).catch(()=>undefined);
...
function InventoryPanel({ ownerId, characterId, onItemsChange, onItemUsed }) {
    ...
    const [feedback, setFeedback] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const { grantXp } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useXp$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useXp"])(ownerId, characterId);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!ownerId) {
            setItems([]);
            return;
...
function CityPage() {
    ...
    const [bestiaryOpen, setBestiaryOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [warState, setWarState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [bestiaryEntries, setBestiaryEntries] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    const ownerId = sessionState?.ownerId ?? "";
    const characterId = sessionState?.characterId ?? "";
    const loadBestiaryProfile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (currentOwnerId, currentCharacterId)=>{
        try {
            const table = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clientApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getJSON"])(`/api/bestiary/get?ownerId=${currentOwnerId}&characterId=${currentCharacterId}`);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const loadWar = async ()=>{
            try {
                const state = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clientApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getJSON"])("/api/factions/war");
    ...
    const handleGoldChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((gold)=>{
        setCharacterInfo((previous)=>previous ? {
                ...previous,
                gold
            } : previous);
    }, []);
    const handleBestiaryUpdate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((table)=>{
        setBestiaryEntries(table);
    }, []);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ownerId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(PlayTopNav, {
                links: playNavLinks
            }, void 0, false, {
                fileName: "[project]/app/play/page.tsx",
                lineNumber: 343,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                            ...
                            children: [
                                ...
                                ownerId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(SoundToggleButton, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(BestiaryDrawer, {
                        open: bestiaryOpen,
...
function CityHud({ stats }) {
    const levelFloor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$progression$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["xpForLevel"])(stats.level);
    const nextLevelTarget = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$progression$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["xpForLevel"])(stats.level + 1);
...
function QuickSlots({ ownerId, characterId, refreshKey, goldAmount, onItemUsed, onInventoryChange }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            typeof goldAmount === "number" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: slots.map((slot)=>{
            ...
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                children: !isEquipment && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    className: "text-base",
                    children: slot.hint
                }, void 0, false, {
                    fileName: "[project]/app/play/page.tsx",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(Drawer, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                ...
                children: sorted.map((entry)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bdfa5c88._.js.map