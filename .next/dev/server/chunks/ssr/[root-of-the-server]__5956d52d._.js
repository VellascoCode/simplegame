        ...
        (async ()=>{
            ...
            class CityScene extends Phaser.Scene {
                ...
                spawnNPCs() {
                    ...
                    this.npcs.slice(initialCount).forEach((npc)=>this.scheduleSpeech(npc));
                }
                scheduleSpeech(npc) {
                    const messages = [
                ...
                spawnLancer(index = 0) {
                    const position = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["randomPoint"])(this, this.worldWidth, this.worldHeight);
                ...
                handleLancerDeath(lancer) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showFloatingText"])(this, this.player.x, this.player.y - this.player.displayHeight - 30, "+2 XP", "#94f1a4");
                    this.emitCombatLog({
                        message: "+2 XP",
                        tone: "xp"
                    });
                    playToneRef(620);
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$game$2f$drops$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["grantRewards"])(this, this.player, {
...
"[project]/lib/factions.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$factions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/factions.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function CityPage() {
    ...
    const formatFactionNames = (ids)=>ids.map((id)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$factions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FACTION_NAMES"][id] ?? `Facção ${id}`).join(" & ");
    const countFactionMembers = (ids, remaining)=>ids.reduce((sum, faction)=>sum + (remaining[faction] ?? 0), 0);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: [
            warState && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    "⚔️ Guerra de Facções: ",
                    formatFactionNames(warState.teamA),
                    " (",
                    countFactionMembers(warState.teamA, warState.remaining),
                    ") vs ",
                    formatFactionNames(warState.teamB),
                    " (",
                    countFactionMembers(warState.teamB, warState.remaining),
                    ")"
                ]
            }, void 0, true, {
                fileName: "[project]/app/play/page.tsx",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5956d52d._.js.map