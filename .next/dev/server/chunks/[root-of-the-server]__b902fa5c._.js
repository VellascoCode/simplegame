...
"[project]/api/bestiary/service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function ensureCharacter(ownerId, characterId) {
...
async function loadBestiary(payload) {
    const data = __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Bestiary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["bestiaryGetSchema"].parse(payload);
    await ensureCharacter(data.ownerId, data.characterId);
    const profile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repositories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getBestiaryProfile"])(data.ownerId, data.characterId);
    return profile?.entries ?? [];
}
async function updateBestiary(payload) {
    const data = __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Bestiary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["bestiaryUpdateSchema"].parse(payload);
    await ensureCharacter(data.ownerId, data.characterId);
    const profile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repositories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["incrementBestiaryKill"])(data.ownerId, data.characterId, data.monsterId);
    return profile.entries;
}
}),
...
"[project]/app/api/bestiary/update/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$bestiary$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/api/bestiary/service.ts [app-route] (ecmascript)");
...
async function POST(request) {
    try {
        ...
        const entries = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$bestiary$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateBestiary"])(payload);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ok"])(entries);
    } catch (err) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["error"])(err instanceof Error ? err.message : "Falha ao atualizar bestiário");
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__b902fa5c._.js.map