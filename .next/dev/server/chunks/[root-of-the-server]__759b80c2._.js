...
"[project]/api/house/service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function loadHouse(ownerId) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repositories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getHouse"])(ownerId);
}
async function saveHouse(payload) {
    const data = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["houseUpdateSchema"].parse(payload);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repositories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateHouse"])(data.ownerId, data.furniture);
}
}),
...
"[project]/app/api/house/update/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$house$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/api/house/service.ts [app-route] (ecmascript)");
...
async function POST(request) {
    try {
        ...
        const house = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$house$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveHouse"])(payload);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ok"])(house);
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__759b80c2._.js.map