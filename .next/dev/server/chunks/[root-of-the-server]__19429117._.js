...
"[project]/app/api/online/ping/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const state = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$online$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ping"])(payload);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ok"])(state);
    } catch (err) {
...
function getMessage(err) {
    return err instanceof Error ? err.message : "Falha ao registrar presença";
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__19429117._.js.map