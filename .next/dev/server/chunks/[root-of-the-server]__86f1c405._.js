...
async function addItem(payload) {
    ...
    const index = current.findIndex((item)=>item.id === data.item.id);
    if (index >= 0) {
        const newQuantity = Math.min(STACK_LIMIT, current[index].quantity + data.item.quantity);
        current[index] = {
            ...current[index],
        ...
        current.push({
            ...data.item,
            quantity: Math.min(STACK_LIMIT, data.item.quantity)
        });
    }
...
async function removeItem(payload) {
    ...
    const current = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repositories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getInventory"])(data.ownerId);
    const index = current.findIndex((item)=>item.id === data.itemId);
    if (index === -1 || current[index].quantity < data.quantity) {
    ...
    next[index] = {
        ...next[index],
        quantity: next[index].quantity - data.quantity
    };
    const filtered = next.filter((item)=>item.quantity > 0);
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repositories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveInventory"])(data.ownerId, filtered);
    return filtered;
}
}),
...
"[project]/api/forest/service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function killCreature(payload) {
    const data = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["forestKillSchema"].parse(payload);
    const reward = {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$inventory$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addItem"])({
...
"[project]/app/api/forest/kill/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$forest$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/api/forest/service.ts [app-route] (ecmascript)");
...
async function POST(request) {
    try {
        ...
        const reward = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$forest$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["killCreature"])(payload);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ok"])(reward);
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__86f1c405._.js.map