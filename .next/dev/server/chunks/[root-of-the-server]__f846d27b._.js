...
async function getCollection(name) {
    ...
    return cli.db("spinazzi").collection(name);
}
...
"[project]/api/auth/service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function register(payload) {
    const data = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerSchema"].parse(payload);
    const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repositories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findUserByEmail"])(data.email);
    if (existing) {
        throw new Error("Usuário já existe");
    }
    const bundle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hash$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(data.password);
    const user = {
        email: data.email,
    ...
    const stored = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repositories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["insertUser"])(user);
    return {
        id: stored._id,
        email: stored.email
    };
...
async function login(payload) {
    const data = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["loginSchema"].parse(payload);
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repositories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findUserByEmail"])(data.email);
    if (!user || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hash$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyPassword"])(data.password, {
...
"[project]/lib/sessionCookie.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const SESSION_COOKIE = "session_owner";
const cookieOptions = {
    httpOnly: true,
    sameSite: "lax",
    path: "/"
};
function setSessionCookie(response, ownerId) {
...
async function getSessionOwnerId(store) {
    const cookieStore = store ?? await Promise.resolve((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])());
...
var __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$auth$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/api/auth/service.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sessionCookie$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/sessionCookie.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repositories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/repositories.ts [app-route] (ecmascript)");
;
;
;
;
async function GET() {
    const ownerId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sessionCookie$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionOwnerId"])();
    if (ownerId) {
    ...
    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$auth$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logout"])();
    const response = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ok"])(data);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sessionCookie$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["clearSessionCookie"])(response);
    return response;
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__f846d27b._.js.map