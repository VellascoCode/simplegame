...
async function POST(request) {
    try {
        ...
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$auth$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["login"])(payload);
        ...
        if (data.id) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sessionCookie$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setSessionCookie"])(response, data.id);
        }
        return response;
    } catch (err) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["error"])(getMessage(err), 401);
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ea689155._.js.map