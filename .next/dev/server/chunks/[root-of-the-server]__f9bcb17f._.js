...
"[project]/app/api/quickslots/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const slots = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repositories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getQuickSlots"])(ownerId);
...
async function POST(request) {
    ...
    if (slotsInput.length !== 4) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["error"])("slots deve conter 4 itens", 400);
    }
    const normalized = slotsInput.map((slot)=>{
        if (slot === null || slot === undefined) return null;
        return typeof slot === "string" && slot.trim().length > 0 ? slot : null;
    });
    const slots = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repositories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveQuickSlots"])(ownerId, normalized);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ok"])({
        slots
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f9bcb17f._.js.map